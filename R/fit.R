...
#'
#' @param formula un truc pour tester @param data un truc pour tester @param eta un truc pour tester @param iter_Max un truc pour tester @param mode un truc pour tester @param batch_size un truc pour tester @param tol un truc pour tester @param coefs un truc pour tester @param intercept un truc pour tester @param nb_Coeurs oui oui
#'
